...
sql.query = {
	...
	query_request_inprog: 'SELECT * FROM job_request WHERE job_request.job_id=$1 AND EXISTS (SELECT 1 FROM request_in_progress WHERE job_id=$1)',
	query_offer_inprog: 'SELECT * FROM job_offer WHERE job_offer.job_id=$1 AND EXISTS (SELECT 1 FROM offer_in_progress WHERE job_id=$1)',
